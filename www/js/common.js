...
/*newly adding**/
        ...
        if(document.getElementById("idDelImgDamagePhotoImg").innerHTML != ""){
            ...
            //$('#idDelImgDamagePhotoImg').innerHTML="";
        }
		...
		jAlert(
				"Your data will be uploaded to the <br/>AA Accident Website. It may take between 10 <br/>minutes to 24 hours, depending your internet <br/>connectivity to reflect all your uploaded <br/>data on www.aaacident.co.za",
				"");
...
db.transaction(function (tx) {
   ...
   // tx.executeSql("drop table SalesAgent");
  ...
  // jAlert("db" + db,"");
   ...
   tx.executeSql("INSERT INTO AAAccommodation(Name, AA_rating, Latitude, Longitude, Seopermalink, PhoneNumber, Email) VALUES ('1 Marichel', 3, -29.52104, 31.22708, 'http://www.aaholidays.co.za/accommodation/south-africa/kwazulu-natal/ballito/1-marichel-PA45854', '+27 (0)83 652-5953', 'djsibbald@yahoo.com')");
    ...
    tx.executeSql("INSERT INTO AAAccommodation (Name, AA_rating, Latitude, Longitude, Seopermalink, PhoneNumber, Email) VALUES ('Thatches Of Bryanston', 3, -26.05035, 28.03455, 'http://www.aaholidays.co.za/accommodation/south-africa/gauteng/bryanston/thatches-of-bryanston-PA1043', '27 (0)11 706 5001 ', 'info@thatches-of-bryanston.co.za')");
